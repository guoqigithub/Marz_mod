...
SpectralLines.prototype.initialiseDefault = function() {
    ...
    this.addSpectralLine('SiII1260','SiII1260', 'Silicon 2', 1260.4221, 1, 2, 1, 'shift+si1260');
    this.addSpectralLine('OI1302','O11302', 'Oxygen 1',      1302.1685, 1, 2, 1, 'shift+o11302');
    this.addSpectralLine('SiII1304','SiII1304', 'Silicon 2', 1304.3702, 1, 2, 1, 'shift+si1304');
    this.addSpectralLine('CII1334','CII1334', 'Carbon 2',    1334.5323, 1, 2, 1, 'shift+c1334');
    this.addSpectralLine('SiIV1393','SiIV1393', 'Silicon 4', 1393.76018,1, 2, 1, 'shift+si1393');
    this.addSpectralLine('SiIV1402','SiIV1402', 'Silicon 4', 1402.77291,1, 2, 1, 'shift+si1402');
    this.addSpectralLine('SiII1526','SiII1526', 'Silicon 2', 1526.70698,1, 2, 1, 'shift+si1526');
    this.addSpectralLine('CIV1548', 'CIV1548',  'Carbon 4',  1548.204,  1, 2, 1, 'shift+c1548');
    this.addSpectralLine('CIV1550', 'CIV1550', 'Carbon 4',   1550.781 , 1, 2, 1, 'shift+c1550');
    this.addSpectralLine('FeII1608','FeII1608', 'Ion 2',     1608.45085,1, 2, 1, 'shift+f1608');
    this.addSpectralLine('AlII1670','AlII1670', 'Aluminium 2',1670.7886,1, 2, 1, 'shift+a1670');
};
